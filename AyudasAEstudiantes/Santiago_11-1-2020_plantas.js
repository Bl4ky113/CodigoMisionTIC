...
do{
  ...
  if(fmla == 1 || fmla == 2 || fmla == 3 ){
    var altPlntInicio = parseFloat(prompt("Inserte el tamaño de la planta(en metros)"));
    if(fmla == 1 && altPlntInicio<20 || fmla == 2 && Tinicial < 100 || fmla == 3 && Tinicial < 4){
      switch(fmla){
        case 1:
          Tmaximo = 20;
          tasa = 0,02;
  ...
  } while(crecimiento <= Tmaximo){ //Este While no se puede usar
    document.write("<br",promedioD,"</br>")

    }
} while(nPlantas <= 2){ //Este While no se puede usar
